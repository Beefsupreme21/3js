...
export default function Trajectory() {
    const { aimAngle, ballPosition, ballVelocity, targetPower } = useGolf2();
    ...
    // Calculate trajectory based on target power goal (not current charging power)
    const geometry = useMemo(() => {
        ...
        const speed = (targetPower / 100) * maxSpeed;
        const launchAngle = 0.6; // Increased launch angle for more visible arc (in radians)
