...
export default function Golf3Overlay() {
    const { isGameStarted, startGame, power, targetPower, isCharging, club, setClub, isInHole, resetBall } = useGolf3();
            ...
            {isInHole && (
                <div className="absolute inset-0 z-30 flex items-center justify-center">
                    ...
                    <div className="relative flex flex-col items-center gap-4">
                        <h2 className="font-mono text-6xl font-black tracking-widest text-green-400">
                            HOLE IN ONE!
                        </h2>
                        <button
                            onClick={resetBall}
